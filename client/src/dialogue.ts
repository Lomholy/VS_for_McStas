...
// Every time.
function runPythonParserAndReadJSON(component: string): Promise<any> {
    const mcstasPath = vscode.workspace.getConfiguration().get<string>('componentViewer.rootPath');
    if (!mcstasPath) {
    ...
    return new Promise((resolve, reject) => {
        ...
        execFile('conda', ['run', '-n', 'mcstas', 'python', pythonScript, component, mcstasPath, outputPath] , {}, (
